...
@section('content')
                  ...
                  <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                     ...
                     <div class="test_box">
                        <div class="text-bg">
                           ...
                           <p class="mt-5" style="font-weight: 300 !important;">Ashagari in Amharic means <i>"the one
                                 who
                                 helps transform"</i>, and with this spirit of transformation we lead the youth, woman
                              and
                              young leaders to
                              realize their maximum potential </p>
                           <a class="read_more hero_btn shadow p-3 mx-2" href="#about">Get To Know Us</a>
                           <a class="Donate-btn-outline  shadow p-3 mb-5 mx-2 hero_btn"
   ...
   <!--Counter-->
   <section class="stat_bg wow fadeIn animated p-5 "
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-2 col-md-4 col-6">
                  <a href="#"><img src="/images/clients/client1.png" class="img-fluid" style="height: 120px !important;"
                        alt="Addis Ababa University"></a>
               </div>
               <div class="col-lg-2 col-md-4 col-6">
                  <a href="#"><img src="/images/clients/client2.png" class="img-fluid" style="height: 120px !important;"
                        alt="Addis Ababa City Administration"></a>
               </div>
               <div class="col-lg-2 col-md-4 col-6">
                  <a href="#"><img src="/images/clients/client3.png" class="img-fluid" style="height: 120px !important;"
                        alt="Ministry of Women and Children, FDRE"></a>
               </div>
               <div class="col-lg-2 col-md-4 col-6">
                  <a href="#"><img src="/images/clients/client4.png" class="img-fluid" style="height: 120px !important;"
                        alt="Ministry of Health, FDRE"></a>
               </div>
               <div class="col-lg-2 col-md-4 col-6">
                  <a href="#"><img src="/images/clients/client7.png" class="img-fluid" style="height: 120px !important;"
                        alt="Ministry of Revenues, FDRE"></a>
               </div>
               <div class="col-lg-2 col-md-4 col-6">
                  <a href="#"><img src="/images/clients/client6.png" class="img-fluid" style="height: 120px !important;"
                        alt="Customs Commission, FDRE"></a>
               </div>
            </div>
         </div>
      </section>
